...
#include "global_variable.h"       //全局变量
#include "allinit.h"               //所有初始化
#include "handle_img.h"            //图像处理
#include "get_center.h"            //中线提取
#include "duoji.h"                 //舵机控制
#include "dianji.h"                //电机控制
#include "LCD_show.h"              //LCD显示
#include "jiwan.h"                 //急弯控制
